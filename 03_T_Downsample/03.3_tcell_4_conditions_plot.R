...
dim(data)
data <- data[data$cryopreservation == 'Fresh',]
dim(data)
...
data$condition <- factor(data$condition, levels = c('Act_IL1B_IL23', 'Act_IL1B_IL23_PGE2', 'Act_IL1B_IL23_TGFB', 'Act_IL1B_IL23_PGE2_TGFB'))
...
pdf('../plots/4_conditions/proportion_annotated_updated.pdf', width = 8, height = 4)
print(p1)
dev.off()
...
data_plot <- rbind(data_plot[data_plot$Conditions == 'Act_IL1B_IL23',],
                   data_plot[data_plot$Conditions == 'Act_IL1B_IL23_TGFB',],
                   data_plot[data_plot$Conditions == 'Act_IL1B_IL23_PGE2',],
                   data_plot[data_plot$Conditions == 'Act_IL1B_IL23_PGE2_TGFB',])

mycolplot <- function(donor){
  p <- ggplot(data_plot[data_plot$Donor == donor,], aes(x = Clusters, y = Proportions, fill = Conditions))+
    geom_col(position = 'dodge', col = 'white')+
    theme_bw()+
    theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=0), legend.position = 'none', plot.title = element_text(hjust = 0.5)) + xlab('') + ylab('Proportion (%)') + ggtitle(donor) +
    scale_fill_npg() + labs(fill = '')
  return(p)
}

p1 <- mycolplot('SB770848') + rremove('x.text')
p2 <- mycolplot('SB775372') + rremove('x.text')
p3 <- mycolplot('SB775393') + rremove('x.text')
p4 <- mycolplot('SB775465') + rremove('x.text') 
p5 <- mycolplot('SB775477') + rremove('x.text')
p6 <- mycolplot('SB775449') + rremove('x.text')
p7 <- mycolplot('SB775483') + theme(legend.position = 'bottom')

pdf('../plots/4_conditions/proportion_annotated_updated_split.pdf', width = 8, height = 16)
...
myboxplot <- function(cluster){
  p <- ggboxplot(data_plot[data_plot$Clusters == cluster,], x = "Conditions", y = "Proportions",
    ...
    stat_compare_means(paired = TRUE, method = 't.test', comparisons = list(c("Act_IL1B_IL23", "Act_IL1B_IL23_TGFB"),
                                                                            c("Act_IL1B_IL23_PGE2", "Act_IL1B_IL23_PGE2_TGFB"),
                                                                            c("Act_IL1B_IL23", "Act_IL1B_IL23_PGE2"),
                                                                            c("Act_IL1B_IL23_TGFB", "Act_IL1B_IL23_PGE2_TGFB")))+
...
pdf('../plots/4_conditions/proportion_annotated_updated_pvalue_ttest.pdf', width = 20, height = 16)
wrap_plots(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20,
           ncol = 5)
dev.off()

pdf('../plots/4_conditions/proportion_annotated_updated_legend.pdf', width = 12, height = 5)
p21
dev.off()
...
myboxplot <- function(cluster){
  p <- ggboxplot(data_plot[data_plot$Clusters == cluster,], x = "Conditions", y = "Proportions",
                 fill = "Conditions", add = 'jitter')+ rremove('x.text')+
    stat_compare_means(paired = TRUE, method = 'wilcox.test', comparisons = list(c("Act_IL1B_IL23", "Act_IL1B_IL23_TGFB"),
                                                                                 c("Act_IL1B_IL23_PGE2", "Act_IL1B_IL23_PGE2_TGFB"),
                                                                                 c("Act_IL1B_IL23", "Act_IL1B_IL23_PGE2"),
                                                                                 c("Act_IL1B_IL23_TGFB", "Act_IL1B_IL23_PGE2_TGFB")))+
    theme(legend.position = 'none', axis.title.x = element_text(size = 16), plot.title = element_text(hjust = 0.5)) + xlab('') + ylab('Proportion (%)') + ggtitle(cluster) +
...
pdf('../plots/4_conditions/proportion_annotated_updated_pvalue_wilcox.pdf', width = 20, height = 16)
wrap_plots(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20,
           ncol = 5)
dev.off()
...
mypaired <- function(cluster){
  p <- ggpaired(rbind(data_plot[data_plot$Clusters == cluster,]), 
    ...
    stat_compare_means(method = 't.test', paired = TRUE, comparisons = list(c("Act_IL1B_IL23", "Act_IL1B_IL23_PGE2"),
                                                                            c("Act_IL1B_IL23_TGFB", "Act_IL1B_IL23_PGE2_TGFB"),
                                                                            c("Act_IL1B_IL23", "Act_IL1B_IL23_TGFB"),
                                                                            c("Act_IL1B_IL23_PGE2", "Act_IL1B_IL23_PGE2_TGFB")))+
    theme(legend.position = 'none', axis.title.x = element_text(size = 16), plot.title = element_text(hjust = 0.5)) + xlab('') + ylab('Proportion (%)') + ggtitle(cluster) +
    scale_fill_npg() + labs(fill = '')
  return(p)
...
data_plot$Conditions <- factor(data_plot$Conditions, levels = c("Act_IL1B_IL23", "Act_IL1B_IL23_PGE2", "Act_IL1B_IL23_TGFB", "Act_IL1B_IL23_PGE2_TGFB"))
...
pdf('../plots/4_conditions/proportion_annotated_updated_pvalue_ttest_paired_merged.pdf', width = 18, height = 6)
p
dev.off()
...
pdf('../plots/4_conditions/proportion_annotated_updated_pvalue_ttest_paired.pdf', width = 20, height = 16)
wrap_plots(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20,
           ncol = 5)
dev.off()

pdf('../plots/4_conditions/proportion_annotated_updated_legend_paired.pdf', width = 12, height = 5)
p21
dev.off()
...
pdf('../plots/4_conditions/proportion_annotated_updated_pvalue_wilcox_paired_merged.pdf', width = 18, height = 6)
p
dev.off()
...
pdf('../plots/4_conditions/proportion_annotated_updated_pvalue_wilcox_paired.pdf', width = 20, height = 16)
wrap_plots(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20,
           ncol = 5)
dev.off()

###################
data <- readRDS('../output/tcell_annotated_updated_4_conditions.RDS')
...
pdf('../plots/4_conditions/activated_resting.pdf', width = 8, height = 4)
print(p1 | p2)
dev.off()

p3 <- DimPlot(data, reduction = 'wnn2.umap', group.by = 'condition', raster = T)
pdf('../plots/4_conditions/conditions.pdf', width = 6, height = 4)
p3
dev.off()

p4 <- DimPlot(data, reduction = 'wnn2.umap', group.by = 'condition', raster = T, cells = colnames(data)[data$condition %in% c("Act_IL1B_IL23", "Act_IL1B_IL23_PGE2")], cols = hue_pal()(4)[1:2]) + ggtitle('Without TGFB') + theme(legend.position = 'bottom')
p5 <- DimPlot(data, reduction = 'wnn2.umap', group.by = 'condition', raster = T, cells = colnames(data)[data$condition %in% c("Act_IL1B_IL23_TGFB", "Act_IL1B_IL23_PGE2_TGFB")], cols = hue_pal()(4)[3:4]) + ggtitle('With TGFB') + theme(legend.position = 'bottom')
pdf('../plots/4_conditions/conditions_split.pdf', width = 8, height = 4)
print(p4 | p5)
dev.off()

pdf('../plots/4_conditions/activated_resting_condition.pdf', width = 11, height = 11)
wrap_plots(p1,p2,p4,p5, ncol = 2)
dev.off()

p4 <- DimPlot(data, reduction = 'wnn2.umap', group.by = 'condition', raster = T, cells = colnames(data)[data$condition %in% c("Act_IL1B_IL23", "Act_IL1B_IL23_PGE2")]) + ggtitle('Without TGFB') + theme(legend.position = 'bottom')
p5 <- DimPlot(data, reduction = 'wnn2.umap', group.by = 'condition', raster = T, cells = colnames(data)[data$condition %in% c("Act_IL1B_IL23_TGFB", "Act_IL1B_IL23_PGE2_TGFB")]) + ggtitle('With TGFB') + theme(legend.position = 'bottom')
pdf('../plots/4_conditions/conditions_split_updated.pdf', width = 8, height = 4)
print(p4 | p5)
dev.off()

pdf('../plots/4_conditions/activated_resting_condition_updated.pdf', width = 11, height = 11)
wrap_plots(p1,p2,p4,p5, ncol = 2)
dev.off()

Idents(data) = 'celltype_updated'
pdf('../plots/4_conditions/celltypes.pdf', width = 10, height = 8)
DimPlot(data, reduction = 'wnn2.umap', label = T, repel = T, label.size = 4, raster = T) + guides(col = guide_legend(ncol = 1, override.aes = list(size=4)))
dev.off()
