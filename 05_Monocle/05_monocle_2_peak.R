...
data <- readRDS('../output/tcell_annotated_updated_2_conditions_peak.RDS')
...
saveRDS(cds, file = '../output/monocle_2_peak/cds_original.RDS')
...
pdf('../plots/monocle_2_peak/UMAP_original.pdf', width = 24, height = 16)
wrap_plots(p1, p2, p3, p4, p5, p6, ncol = 3)
dev.off()

library(cowplot)
pdf('../plots/monocle_2_peak/UMAP_original_lineage.pdf', width = 4, height = 4)
...
saveRDS(cds, file = '../output/monocle_2_peak/cds.RDS')
...
pdf('../plots/monocle_2_peak/UMAP.pdf', width = 24, height = 16)
wrap_plots(p1, p2, p3, p4, p5, p6, ncol = 3)
dev.off()