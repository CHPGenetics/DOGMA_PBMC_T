...
saveRDS(cds, file = '../output/monocle/cds_original.RDS')
...
pdf('../plots/monocle/UMAP_original.pdf', width = 24, height = 16)
wrap_plots(p1, p2, p3, p4, p5, p6, ncol = 3)
dev.off()

library(cowplot)
pdf('../plots/monocle/UMAP_original_lineage.pdf', width = 4, height = 4)
...
saveRDS(cds, file = '../output/monocle/cds.RDS')
...
pdf('../plots/monocle/UMAP.pdf', width = 24, height = 16)
wrap_plots(p1, p2, p3, p4, p5, p6, ncol = 3)
dev.off()