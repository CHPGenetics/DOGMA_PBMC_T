...
cds <- readRDS('../output/monocle/cds_original.RDS')
...
cds_sub <- order_cells(cds_sub, root_pr_nodes=get_earliest_principal_node(cds_sub, 'CD4+ Naive (Resting)'))
...
cds_sub_cut <- cds_sub[,which(pseudotime(cds_sub) < 12.48153)]
...
cds_sub_cut <- order_cells(cds_sub_cut, root_pr_nodes='Y_76')
p3 <- plot_cells(cds_sub_cut, color_cells_by = "pseudotime",
                 label_groups_by_cluster=FALSE,
                 label_leaves=FALSE,
                 label_branch_points=FALSE)
p1 | p2 | p3
save(cds_sub, cds_sub_cut, file = '../output/monocle/cd4_naive.RData')

write.csv(pseudotime(cds_sub_cut), file = '../output/monocle/cd4_naive.csv')
...
cds_sub <- order_cells(cds_sub, root_pr_nodes='Y_48')
...
cds_sub_cut <- choose_cells(cds_sub)
max(pseudotime(cds_sub_cut))
cds_sub_cut <- cds_sub[,which(pseudotime(cds_sub) < 15)]
cds_sub_cut_cut <- choose_graph_segments(cds_sub_cut)
cds_sub_cut <- cds_sub_cut[,which(!colnames(cds_sub_cut) %in% colnames(cds_sub_cut_cut))]
cds_sub_cut_cut <- choose_graph_segments(cds_sub_cut)
cds_sub_cut <- cds_sub_cut[,which(!colnames(cds_sub_cut) %in% colnames(cds_sub_cut_cut))]
...
cds_sub_cut <- cds_sub_cut[,which(!colnames(cds_sub_cut) %in% colnames(cds_sub_cut_cut))]
p1 | plot_cells(cds_sub_cut, color_cells_by = "pseudotime",
           label_groups_by_cluster=FALSE,
           label_leaves=FALSE,
           label_branch_points=FALSE)
df <- my_get_earliest_principal_node(cds_sub_cut, c('CD4+ Memory (Resting) - Th1', 'CD4+ Memory (Resting) - Th17', 'CD4+ Memory (Resting) - Tfh', 'CD4+ Memory (Resting) - Other'))
cds_sub_cut <- order_cells(cds_sub_cut, root_pr_nodes='Y_48')
p2 <- plot_cells(cds_sub_cut, color_cells_by = "pseudotime",
                 label_groups_by_cluster=FALSE,
                 label_leaves=FALSE,
                 label_branch_points=FALSE)
...
p1 | p2
save(cds_sub, cds_sub_cut, file = '../output/monocle/cd4_memory.RData')

write.csv(pseudotime(cds_sub_cut), file = '../output/monocle/cd4_memory.csv')
...
cds_sub <- order_cells(cds_sub, root_pr_nodes='Y_652')
...
cds_sub_cut_cut <- choose_cells(cds_sub_cut)
cds_sub_cut <- cds_sub_cut[,which(!colnames(cds_sub_cut) %in% colnames(cds_sub_cut_cut))]
df <- my_get_earliest_principal_node(cds_sub_cut, c('CD8+ Naive (Resting)'))
cds_sub_cut <- order_cells(cds_sub_cut, root_pr_nodes='Y_652')
p2 <- plot_cells(cds_sub_cut, color_cells_by = "pseudotime",
                 label_groups_by_cluster=FALSE,
                 label_leaves=FALSE,
                 label_branch_points=FALSE)
...
p1 | p2
save(cds_sub, cds_sub_cut, file = '../output/monocle/cd8_naive.RData')

write.csv(pseudotime(cds_sub_cut), file = '../output/monocle/cd8_naive.csv')
...
cds_sub <- order_cells(cds_sub, root_pr_nodes='Y_167')
...
cds_sub_cut <- choose_cells(cds_sub)
max(pseudotime(cds_sub_cut))
cds_sub_cut <- cds_sub[,which(pseudotime(cds_sub) < 13.72743)]
cds_sub_cut_cut <- choose_graph_segments(cds_sub_cut)
cds_sub_cut <- cds_sub_cut[,which(!colnames(cds_sub_cut) %in% colnames(cds_sub_cut_cut))]
cds_sub_cut_cut <- choose_graph_segments(cds_sub_cut)
cds_sub_cut <- cds_sub_cut[,which(!colnames(cds_sub_cut) %in% colnames(cds_sub_cut_cut))]
...
p1|plot_cells(cds_sub_cut, color_cells_by = "pseudotime",
           ...
           label_leaves=FALSE,
           label_branch_points=FALSE)
df <- my_get_earliest_principal_node(cds_sub_cut, c('CD8+ Memory (Resting)'))
cds_sub_cut <- order_cells(cds_sub_cut, root_pr_nodes='Y_167')
p2 <- plot_cells(cds_sub_cut, color_cells_by = "pseudotime",
                 label_groups_by_cluster=FALSE,
                 label_leaves=FALSE,
                 label_branch_points=FALSE)
...
p1 | p2
save(cds_sub, cds_sub_cut, file = '../output/monocle/cd8_memory.RData')

write.csv(pseudotime(cds_sub_cut), file = '../output/monocle/cd8_memory.csv')
...
cds_sub <- order_cells(cds_sub, root_pr_nodes='Y_320')
...
cds_sub_cut <- choose_cells(cds_sub)
max(pseudotime(cds_sub_cut))
cds_sub_cut <- cds_sub[,which(pseudotime(cds_sub) < 10)]
cds_sub_cut_cut <- choose_graph_segments(cds_sub_cut)
cds_sub_cut <- cds_sub_cut[,which(!colnames(cds_sub_cut) %in% colnames(cds_sub_cut_cut))]
cds_sub_cut_cut <- choose_graph_segments(cds_sub_cut)
cds_sub_cut <- cds_sub_cut[,which(!colnames(cds_sub_cut) %in% colnames(cds_sub_cut_cut))]
cds_sub_cut_cut <- choose_cells(cds_sub_cut)
cds_sub_cut <- cds_sub_cut[,which(!colnames(cds_sub_cut) %in% colnames(cds_sub_cut_cut))]
df <- my_get_earliest_principal_node(cds_sub_cut, c('MAITs (Resting)'))
cds_sub_cut <- order_cells(cds_sub_cut, root_pr_nodes='Y_320')
p2 <- plot_cells(cds_sub_cut, color_cells_by = "pseudotime",
                 label_groups_by_cluster=FALSE,
                 label_leaves=FALSE,
                 label_branch_points=FALSE)
...
p1 | p2
save(cds_sub, cds_sub_cut, file = '../output/monocle/mait.RData')

write.csv(pseudotime(cds_sub_cut), file = '../output/monocle/mait.csv')
...
plot_pseudotime <- function(name, title){
  ...
  pdf(paste0('../plots/monocle/monocle_', name, '.pdf'), width = 4, height = 4)
  print(p)
  dev.off()
  return(p)
}
...
p3 <- plot_pseudotime('cd8_naive', 'CD8+ naive T cells')
p4 <- plot_pseudotime('cd8_memory', 'CD8+ memory T cells')
p5 <- plot_pseudotime('mait', 'MAITs')
# plot_pseudotime('Th17_Th1', '')

pdf(paste0('../plots/monocle/monocle_plots.pdf'), width = 20, height = 4)
wrap_plots(p1, p2, p3, p4, p5, ncol = 5)
dev.off()
