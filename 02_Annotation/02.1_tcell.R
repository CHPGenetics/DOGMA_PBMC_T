...
# load('../output/data_harmony_qc.RData')
# 
# plot <- DimPlot(data, reduction = 'wnn.umap', label = TRUE, repel = TRUE, group.by = 'predicted.celltype.l1')
...
# DimPlot(data, reduction = 'wnn.umap', cells.highlight = c(cell1, cell2))
# 
# save(data, file = '../output/data_harmony_qc_tcell.RData')
