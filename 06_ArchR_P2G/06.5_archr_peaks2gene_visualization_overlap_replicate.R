...
pdf('DOGMA_filtered_multiome/Plots/Peak2Gene-Track_modify_label_PTGER4_overlap_link_0.001_replicate.pdf', width = 10, height = 10)
p_new
dev.off()
...
modifyTrack_label_link_new <- function(p){
  ...
  p_new <- plot_spacer() + p6 + plot_spacer() + p5 + plot_spacer() + p4 + p3 + p2 + p12 + p1 +
    plot_layout(ncol = 2, heights = c(2.2, 0.2, 0.8, 8, 10), widths = c(1,10))
  
  return(p_new)
}

p_new <- modifyTrack_label_link_new(p)
pdf('DOGMA_filtered_multiome/Plots/Peak2Gene-Track_modify_label_PTGER4_overlap_replicate_combined.pdf', width = 10, height = 10)
p_new
dev.off()
...
p_new <- modifyTrack_label_link(p)
pdf('DOGMA_filtered_multiome/Plots/Peak2Gene-Track_modify_label_PTGER4_overlap_link_0.001_replicate_subset.pdf', width = 10, height = 3.4)
p_new
dev.off()
...
p_new <- modifyTrack_label_link_new(p)
pdf('DOGMA_filtered_multiome/Plots/Peak2Gene-Track_modify_label_PTGER4_overlap_replicate_subset_combined.pdf', width = 10, height = 6)
p_new
dev.off()
