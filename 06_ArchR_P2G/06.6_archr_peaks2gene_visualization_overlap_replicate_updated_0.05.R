...
pdf('../../plots/visualization/Peak2Gene-Track_modify_label_PTGER4_overlap_link_0.05_replicate_combined.pdf', width = 10, height = 10)
p_new
dev.off()
...
p_new <- modifyTrack_label_link_new(p)
pdf('../../plots/visualization/Peak2Gene-Track_modify_label_LNPEP_overlap_link_0.05_replicate_combined.pdf', width = 10, height = 10)
p_new
dev.off()
...
p_new <- modifyTrack_label_link_new(p)
pdf('../../plots/visualization/Peak2Gene-Track_modify_label_TNFRSF14_overlap_link_0.05_replicate_combined.pdf', width = 10, height = 10)
p_new
dev.off()
...
p_new <- modifyTrack_label_link_new(p)
pdf('../../plots/visualization/Peak2Gene-Track_modify_label_IL2RA_overlap_link_0.05_replicate_combined.pdf', width = 10, height = 10)
p_new
dev.off()
...
p_new <- modifyTrack_label_link_new(p)
pdf('../../plots/visualization/Peak2Gene-Track_modify_label_CCL20_overlap_link_0.05_replicate_combined.pdf', width = 10, height = 10)
p_new
dev.off()
...
p_new <- modifyTrack_label_link_new(p)
pdf('../../plots/visualization/Peak2Gene-Track_modify_label_CXCR5_overlap_link_0.05_replicate_combined.pdf', width = 10, height = 10)
p_new
dev.off()
...
p_new <- modifyTrack_label_link_new(p)
pdf('../../plots/visualization/Peak2Gene-Track_modify_label_ITGAL_overlap_link_0.05_replicate_combined.pdf', width = 10, height = 10)
p_new
dev.off()
...
p_new <- modifyTrack_label_link_new(p)
pdf('../../plots/visualization/Peak2Gene-Track_modify_label_IFNLR1_overlap_link_0.05_replicate_combined.pdf', width = 10, height = 10)
p_new
dev.off()
...
p_new <- modifyTrack_label_link_new(p)
pdf('../../plots/visualization/Peak2Gene-Track_modify_label_RUNX3_overlap_link_0.05_replicate_combined.pdf', width = 10, height = 10)
p_new
dev.off()
...
p_new <- modifyTrack_label_link_new(p)
pdf('../../plots/visualization/Peak2Gene-Track_modify_label_KLRC4_overlap_link_0.05_replicate_combined.pdf', width = 10, height = 10)
p_new
dev.off()
...
p_new <- modifyTrack_label_link_new(p)
pdf('../../plots/visualization/Peak2Gene-Track_modify_label_IL21_overlap_link_0.05_replicate_combined.pdf', width = 10, height = 10)
p_new
dev.off()
...
p_new <- modifyTrack_label_link_new(p)
pdf('../../plots/visualization/Peak2Gene-Track_modify_label_GPR65_overlap_link_0.05_replicate_combined.pdf', width = 10, height = 10)
p_new
dev.off()
...
p_new <- modifyTrack_label_link_new(p)
pdf('../../plots/visualization/Peak2Gene-Track_modify_label_BLK_overlap_link_0.05_replicate_combined.pdf', width = 10, height = 10)
p_new
dev.off()
...
p_new <- modifyTrack_label_link_new(p)
pdf('../../plots/visualization/Peak2Gene-Track_modify_label_CD44_overlap_link_0.05_replicate_combined.pdf', width = 10, height = 10)
p_new
dev.off()
