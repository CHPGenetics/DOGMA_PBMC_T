...
###ldsc
ldsc_outpath=${PROJ_PATH}Results/02_S_LDSC/Output/Seurat_DE/
...
gs_file=${input_path}Gene_list_${celltype}.txt
...
ldsc_outpath=${PROJ_PATH}Results/02_S_LDSC/Output/Seurat_DE/Result/
