...
ldsc_outpath=${PROJ_PATH}Results/02_S_LDSC/Output/Annotation_Gene/
...
gs_file=${input_path}Gene_list.txt
gc_file=${input_path}Gene_coord_all.txt
...
###ldsc
ldsc_outpath=${PROJ_PATH}Results/02_S_LDSC/Output/Pseudo_Condition_DE/
...
gs_file=${input_path}Pseudo_Condition/Gene_list_${celltype}.txt
gc_file=${input_path}Gene_coord_all.txt
b_ref=${pf_path}1000G.EUR.QC.${chr}
hmp_file=${hmp_path}hm.${chr}.snp
...
ldsc_outpath=${PROJ_PATH}Results/02_S_LDSC/Output/Pseudo_Condition_DE/Result/
