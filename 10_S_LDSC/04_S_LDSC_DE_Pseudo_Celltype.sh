...
###ldsc
ldsc_outpath=${PROJ_PATH}Results/02_S_LDSC/Output/Pseudo_Celltype_DE/
...
gs_file=${input_path}Pseudo_Celltype/Gene_list_${celltype}.txt
gc_file=${input_path}Gene_coord_all.txt
b_ref=${pf_path}1000G.EUR.QC.${chr}
hmp_file=${hmp_path}hm.${chr}.snp
...
ldsc_outpath=${PROJ_PATH}Results/02_S_LDSC/Output/Pseudo_Celltype_DE/Result/
