...
# Load data
rna.mat.raw <- readRDS(paste0(WORK_PATH, "rna.predicted.rds"))
...
for(celltype in unique(meta$celltype_updated)){
  ...
  saveRDS(p2g_result, paste0(WORK_PATH, "P2G_Predicted/Emprical/P2G_", celltype, ".rds"))
  
  Result <- rbind(Result, p2g_result)
  print(celltype)
}
saveRDS(Result, paste0(WORK_PATH, "P2G_Predicted/Emprical/All_P2G.rds"))
