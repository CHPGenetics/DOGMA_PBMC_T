...
write.csv(data_plot, file = '../output/SNP_condition_merged/enrich_immune_IBD.csv', col.names = T, row.names = F, quote = F)
...
pdf('../plots/SNP_condition_merged/enrich_immune_IBD.pdf', width = 8, height = 4)
...
pdf('../plots/SNP_condition_merged/enrich_immune_paired_IBD.pdf', width = 10, height = 5)
...
write.csv(data_plot, file = '../output/SNP_condition_merged/enrich_disease_IBD.csv', col.names = T, row.names = F, quote = F)
...
p3 <- ggplot(data_plot3[data_plot3$peak == 'Differentially accessible peaks',], 
  ...
  rremove('x.text')+ 
  coord_fixed(expand = T)
pdf('../plots/SNP_condition_merged/enrich_disease_IBD.pdf', width = 8, height = 7)
p3/p2/p1
dev.off()
...
p3 <- ggplot(data_plot3[data_plot3$peak == 'Differentially accessible peaks',], 
  ...
  rremove('x.text')+ 
  coord_fixed(expand = T)
pdf('../plots/SNP_condition_merged/enrich_disease_IBD_updated.pdf', width = 8, height = 6.5)
p3/p2/p1
dev.off()
