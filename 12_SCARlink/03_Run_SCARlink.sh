...
export XLA_FLAGS=--xla_gpu_cuda_data_dir=/ix1/wchen/xiangyu/conda_env/scarlink/lib/
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/ix1/wchen/xiangyu/conda_env/scarlink/lib/
...
scarlink -o ${WORK_PATH}processing -g hg38 -c celltype_updated
