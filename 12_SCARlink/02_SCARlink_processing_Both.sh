...
--scrna ${WORK_PATH}Act_IL1B_IL23_PGE2_TGFB/dogma_scrna_subset.rds \
--scatac ${WORK_PATH}Act_IL1B_IL23_PGE2_TGFB/DOGMA_ATAC_Subset \
-o ${WORK_PATH}Act_IL1B_IL23_PGE2_TGFB -nc 16
