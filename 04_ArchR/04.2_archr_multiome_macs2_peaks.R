...
load("/ix1/wchen/zhongli/RWorkSpace/DOGMA-seq/PBMC/data/tcell_peaks.RData")
...
proj <- saveArchRProject(ArchRProj = proj, outputDirectory = 'DOGMA_filtered_multiome_peaks')
...
write.csv(corGEM_MM, file = 'DOGMA_filtered_multiome_peaks/corGEM_MM.csv')
...
pdf('DOGMA_filtered_multiome_peaks/Plots/Correlation-Motif-Deviation-TF-Expression.pdf', width = 4, height = 4)
