...
for(i in 1:20){
  ...
  pdf(paste0('../plots/pseudo_bulk/Bulk_label/RNA/', celltype, '.pdf'), width = 7, height = 7)
  print(p)
  dev.off()
  assign(paste0('p',i), draw_plot(celltype))
}

pdf(paste0('../plots/pseudo_bulk/Bulk_label/RNA/', 'Act_IL1B_IL23_PGE2_vs_Act_IL1B_IL23', '.pdf'), width = 35, height = 28)
...
for(i in 1:20){
  ...
  pdf(paste0('../plots/pseudo_bulk/Bulk_label/ATAC/', celltype, '.pdf'), width = 7, height = 7)
  print(p)
  dev.off()
  assign(paste0('p',i), draw_plot_peak(celltype))
}

pdf(paste0('../plots/pseudo_bulk/Bulk_label/ATAC/', 'Act_IL1B_IL23_PGE2_vs_Act_IL1B_IL23', '.pdf'), width = 35, height = 28)
print(wrap_plots(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, ncol = 5))
dev.off()
