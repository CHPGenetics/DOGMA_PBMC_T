...
fwrite(DE_rna, file = '../output/pseudo_bulk_updated/DE_rna_DESeq2_paired.txt', col.names = T, row.names = F, quote = F)
...
fwrite(DE_adt, file = '../output/pseudo_bulk_updated/DE_adt_DESeq2_paired.txt', col.names = T, row.names = F, quote = F)
...
fwrite(DE_peak, file = '../output/pseudo_bulk_updated/DE_peak_DESeq2_paired.txt', col.names = T, row.names = F, quote = F)
