...
fwrite(DE_rna, file = '../output/pseudo_bulk/DE_rna_edgeR_paired.txt', col.names = T, row.names = F, quote = F)
...
fwrite(DE_adt, file = '../output/pseudo_bulk/DE_adt_edgeR_paired.txt', col.names = T, row.names = F, quote = F)
...
fwrite(DE_peak, file = '../output/pseudo_bulk/DE_peak_edgeR_paired.txt', col.names = T, row.names = F, quote = F)
