...
pdf("../plots/pseudo_bulk/ipa/ipa_fdr_0.0001.pdf", width = 10, height = 10)
...
pdf("../plots/pseudo_bulk/ipa/ipa_fdr_0.0001_re.pdf", width = 10, height = 10)
ggplot(ipa_sub, aes(x = celltype, y = `Ingenuity Canonical Pathways`, size = log10_p_val_adj, fill = `z-score`))+
    geom_point(shape=21)+
    scale_fill_gradient2(low = 'dodgerblue3', mid = 'white', high = 'firebrick', na.value = 'darkgray')+
    labs(x = '', y = '', size = '-log10(FDR)')+
...
pdf("../plots/pseudo_bulk/ipa/ipa_fdr_0.0001_re_re.pdf", width = 10, height = 10)
ggplot(ipa_sub, aes(x = celltype, y = `Ingenuity Canonical Pathways`, size = log10_p_val_adj, fill = `z-score`))+
    geom_point(shape=21)+
    scale_fill_gradient2(low = 'dodgerblue3', mid = 'white', high = 'firebrick', na.value = 'darkgray')+
    labs(x = '', y = '', size = '-log10(FDR)')+
...
pdf("../plots/pseudo_bulk/ipa/ipa_fdr_0.001.pdf", width = 12, height = 18)
ggplot(ipa_sub, aes(x = celltype, y = `Ingenuity Canonical Pathways`, size = log10_p_val_adj, fill = `z-score`))+
    geom_point(shape=21)+
    scale_fill_gradient2(low = 'dodgerblue3', mid = 'white', high = 'firebrick', na.value = 'darkgray')+
    labs(x = '', y = '', size = '-log10(FDR)')+
...
pdf("../plots/pseudo_bulk/ipa/ipa_fdr_0.001_re.pdf", width = 12, height = 18)
ggplot(ipa_sub, aes(x = celltype, y = `Ingenuity Canonical Pathways`, size = log10_p_val_adj, fill = `z-score`))+
    geom_point(shape=21)+
    scale_fill_gradient2(low = 'dodgerblue3', mid = 'white', high = 'firebrick', na.value = 'darkgray')+
    labs(x = '', y = '', size = '-log10(FDR)')+
