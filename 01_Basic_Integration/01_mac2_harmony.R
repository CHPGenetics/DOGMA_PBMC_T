...
pdf('../plots/macs2/UMAP_ATAC_batch_macs2.pdf', width = 8, height = 8)
DimPlot(data, reduction = 'atac.umap', group.by = 'sample', label = F, repel = TRUE, label.size = 4)
dev.off()
...
data <- NormalizeData(data, normalization.method = 'CLR', margin = 2) %>%
  ...
  RunHarmony(group.by.vars = c("sample"), max.iter.harmony = 20, reduction = 'apca', assay.use = 'ADT',project.dim = FALSE,  reduction.save = "harmony_ADT")
...
save(data, file = '../output/data_macs2_harmony.RData')

pdf('../plots/macs2/UMAP_macs2_harmony_weighted_cluster_split.pdf', width = 40, height = 40)
DimPlot(data, reduction = 'wnn.umap', split.by = 'sample', label = T, repel = TRUE, label.size = 4, ncol = 5)
dev.off()

pdf('../plots/macs2/UMAP_macs2_harmony_weighted_cluster_split_condition.pdf', width = 32, height = 8)
DimPlot(data, reduction = 'wnn.umap', split.by = 'condition', label = T, repel = TRUE, label.size = 4, ncol = 4)
dev.off()

pdf('../plots/macs2/UMAP_macs2_harmony_RNA_cluster_split.pdf', width = 40, height = 40)
DimPlot(data, reduction = 'rna.umap', split.by = 'sample', label = T, repel = TRUE, label.size = 4, ncol = 5)
dev.off()

pdf('../plots/macs2/UMAP_macs2_harmony_RNA_cluster_split_condition.pdf', width = 32, height = 8)
DimPlot(data, reduction = 'rna.umap', split.by = 'condition', label = T, repel = TRUE, label.size = 4, ncol = 4)
dev.off()

pdf('../plots/macs2/UMAP_macs2_harmony_ADT_cluster_split.pdf', width = 40, height = 40)
DimPlot(data, reduction = 'adt.umap', split.by = 'sample', label = T, repel = TRUE, label.size = 4, ncol = 5)
dev.off()

pdf('../plots/macs2/UMAP_macs2_harmony_ADT_cluster_split_condition.pdf', width = 32, height = 8)
DimPlot(data, reduction = 'adt.umap', split.by = 'condition', label = T, repel = TRUE, label.size = 4, ncol = 4)
dev.off()

pdf('../plots/macs2/UMAP_macs2_harmony_ATAC_cluster_split.pdf', width = 40, height = 40)
DimPlot(data, reduction = 'atac.umap', split.by = 'sample', label = T, repel = TRUE, label.size = 4, ncol = 5)
dev.off()

pdf('../plots/macs2/UMAP_macs2_harmony_ATAC_cluster_split_condition.pdf', width = 32, height = 8)
DimPlot(data, reduction = 'atac.umap', split.by = 'condition', label = T, repel = TRUE, label.size = 4, ncol = 4)
dev.off()

pdf('../plots/macs2/UMAP_macs2_harmony_sample_condition.pdf', width = 16, height = 8)
...
pdf('../plots/macs2/UMAP_macs2_harmony_sample_condition_split.pdf', width = 32, height = 8)
...
pdf('../plots/macs2/predicted_macs2.pdf', width = 24, height = 8)
p1 | p2 | p3
dev.off()

p1 <- DimPlot(data, reduction = 'wnn.umap', label = TRUE, repel = TRUE)
p2 <- DimPlot(data, reduction = 'wnn.umap', label = TRUE, repel = TRUE, group.by = "predicted.celltype.l1") 
pdf('../plots/macs2/predicted_2_macs2.pdf', width = 16, height = 8)
p1 | p2
dev.off()
...
pdf('../plots/macs2/proportion_predicted_slide_macs2.pdf', width = 8, height = 4)
p1
dev.off()
...
p1 <- ggplot(data_plot, aes(x = Clusters, y = Proportions, col = Conditions, fill = Conditions))+
  ...
  theme_bw()+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=0))
pdf('../plots/macs2/proportion_predicted_l2_slide_macs2.pdf', width = 8, height = 4)
p1
dev.off()
